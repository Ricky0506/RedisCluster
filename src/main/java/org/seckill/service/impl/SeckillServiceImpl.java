...
//	private RedisDao redisDao;
	...
	//
	// if (nowTime.getTime() > endTime.getTime() || nowTime.getTime() <
	// startTime.getTime()) {
...
//			if (updateCount <= 0) {
//				// rollback
//				throw new RepeatKillException(SeckillStatEnum.END.getStateInfo());
//			} else {
//				// 秒杀成功 commit
...
//		Seckill seckill = redisDao.getSeckill(seckillId);
		Seckill seckill = redisClusterDao.getSeckill(seckillId);
